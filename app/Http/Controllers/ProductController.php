...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, rules: [
            ...
            'categoryID' => 'required|integer|between:1,2',
...
//Category
    ...
    public function categoryView($name){
        ...
        $product = Product::where('categoryID', $category->id)->paginate(8);


        return view('ViewCategory', compact('product', 'category'));
    ...
    public function search_product(Request $request){
        ...
        $products = Product::where('name', 'LIKE', "%$name_search%")->paginate(4)->withQueryString();
